...
import (
	...
	usermanagementendpoints "github.com/Mitrajeet-Golsangi/diet-application-backend/cmd/user-management-endpoints"
...
func main() {
	...
	usermanagementendpoints.LoadEndpoints(r, database)
